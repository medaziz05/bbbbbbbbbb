...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Idées à évaluer</h5>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= formatDate($idee['date_creation']) ?></td>
                                <td>
                                    <a href="<?= BASE_URL ?>/idees/<?= $idee['id'] ?>" class="btn btn-sm btn-primary">
                ...
                <div class="text-center mt-3">
                    <a href="<?= BASE_URL ?>/evaluations/to-evaluate" class="btn btn-outline-primary">
                        Voir toutes les idées à évaluer
                    </a>
                </div>
                <?php else: ?>
                <div class="text-center text-muted py-4">
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Mes dernières évaluations</h5>
            </div>
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <div>
                        <div class="fw-semibold small"><?= truncate($evaluation['idee_titre'], 30) ?></div>
                ...
                <div class="text-center text-muted py-3">
                    <i class="fas fa-star opacity-50"></i>
                    <p class="mb-0 small">Aucune évaluation</p>
                </div>
                <?php endif; ?>
            </div>
        </div>
